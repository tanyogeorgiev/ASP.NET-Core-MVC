...
{
    public partial class InitialModelsTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfWeekMask = table.Column<int>(nullable: true),
                    EndDate = table.Column<DateTime>(nullable: true),
                    Occurrences = table.Column<int>(nullable: true),
                    RecurrenceEndType = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExaminationDescription = table.Column<string>(nullable: false),
                    PatientId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalSheets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalSheets_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalSheets_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentLabel", x => new { x.AppointmentId, x.LabelId });
                    table.ForeignKey(
                        name: "FK_AppointmentLabel_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppointmentLabel_Labels_LabelId",
                        column: x => x.LabelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalSheetId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequestedScheduleId = table.Column<int>(nullable: false),
                    AppointmentRequestId = table.Column<int>(nullable: false),
                    Confirm = table.Column<bool>(nullable: false,defaultValue:false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleAppointmentRequest", x => new { x.RequestedScheduleId, x.AppointmentRequestId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleAppointments", x => new { x.ScheduleId, x.AppointmentId });
                    table.ForeignKey(
                        name: "FK_ScheduleAppointments_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScheduleAppointments_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentLabel_LabelId",
                table: "AppointmentLabel",
                column: "LabelId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalSheets_DoctorId",
                table: "MedicalSheets",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalSheets_PatientId",
                table: "MedicalSheets",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleAppointments_AppointmentId",
